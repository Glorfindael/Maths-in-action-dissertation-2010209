...
def construct_network_structure(N, c, k, Pn, p_between_echo_chambers):
    ...
    # Select Pn * k * E edges where exactly one node belongs to the cluster
...
# Sort the results based on network polarization values
...
# Plot the results with color mapping based on theta
